...
public class ApplicationLoader extends MultiDexApplication {
    ...
    public void onCreate() {
        ...
        //#)(Q*#)(#*Q)(#*N)Q(#*)Q(#I HERE HERE HERE HERE!!!!!!!!!!!!!!!!!!!!!!!!!!!!

        MobileAds.initialize(ApplicationLoader.applicationContext,
                "");
        if(pref1.getBoolean("alrast",true)){
            SharedPreferences.Editor p = pref1.edit();
            p.putBoolean("view_animations",false).apply();
            p.putBoolean("globalAutodownloadEnabled", false).apply();
            p.putBoolean("alrast",false).apply();
        }
