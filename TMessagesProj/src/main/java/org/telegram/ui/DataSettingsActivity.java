...
public class DataSettingsActivity extends BaseFragment {
                ...
                if (position == photosRow || position == voiceMessagesRow || position == videoMessagesRow || position == videosRow || position == filesRow || position == musicRow || position == gifsRow) {
                    ...
                    builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            if (!MediaController.getInstance().globalAutodownloadEnabled) {
                                MediaController.getInstance().globalAutodownloadEnabled = false;
                                editor.putBoolean("globalAutodownloadEnabled",false);
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public boolean isEnabled(RecyclerView.ViewHolder holder) {
            ...
            return position == storageUsageRow  || position == mobileUsageRow || position == roamingUsageRow || position == wifiUsageRow || position == proxyRow ||
        ...
        public int getItemViewType(int position) {
            if (position == mediaDownloadSection2Row || position == usageSection2Row ||  position == proxySection2Row) {
                return 0;
            } else if (position == mediaDownloadSectionRow || position == usageSectionRow || position == proxySectionRow) {
                return 2;
            } else if (position == autoDownloadMediaRow) {
                return 3;
            } else {
